...
import { sanitizeString, sanitizeUrl, sanitizeEnum } from '../../common/utils/sanitize.util';
...
export class UpdateUserDto {
  ...
  @IsOptional()
  @IsEnum(DELIVERY_METHOD, { message: 'Preferred delivery method must be a valid delivery method' })
  @Transform(({ value }) => value ? sanitizeEnum(value, Object.values(DELIVERY_METHOD)) : undefined)
