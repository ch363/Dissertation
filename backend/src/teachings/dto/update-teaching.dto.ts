...
export class UpdateTeachingDto {
  ...
  @IsOptional()
  @IsString()
  @MaxLength(1000, { message: 'User language string must not exceed 1000 characters' })
  @Transform(({ value }) => value ? sanitizeString(value, 1000) : undefined)
  userLanguageString?: string;

  @IsOptional()
  @IsString()
  @MaxLength(1000, { message: 'Learning language string must not exceed 1000 characters' })
  @Transform(({ value }) => value ? sanitizeString(value, 1000) : undefined)
