        ...
        <View style={[styles.section, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}> 
          <View style={styles.rowBetween}>
            ...
            <Pressable
              ...
              style={[styles.toggle, { backgroundColor: enabled ? theme.colors.primary : theme.colors.border }]}
            >
          ...
          />
          <Text style={[styles.helper, { color: theme.colors.mutedText }]}>Rate: {rate.toFixed(2)} (0.50–1.00)</Text>
        </View>
      </View>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: baseTheme.typography.bold, fontSize: 22, marginBottom: baseTheme.spacing.lg },
  section: {
    borderWidth: 1,
  ...
  // Native slider styles are provided by the library; keep holders for potential theming
});
